...
## 📷 项目运行截图
![聊天首页界面](./images/首页图.png)
![沈阳二日游行程规划效果](./images/效果图1.png)
![沈阳二日游行程规划效果](./images/效果图2.png)
...
初次导入应用可依托 Dify 内置公共天气测试密钥直接体验；高频使用建议前往和风天气官网申请个人免费 API 密钥，替换后调用更稳定无次数限制。
本项目配置文件无账号绑定，导入后使用导入者自身账号大模型额度与第三方接口密钥，原账号资源不受消耗。
